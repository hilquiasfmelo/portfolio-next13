  ...
  return (
    <section className="w-full sm:min-h-[750px] flex flex-col items-center justify-end relative pb-10 sm:pb-24 py-24 px-6 overflow-hidden">
      ...
      <p className="text-gray-400 text-center max-w-[640px] my-4 sm:my-6 text-sm sm:text-base">
        ...
        voluptate laudantium alias necessitatibus magni? Commodi blanditiis
        labore amet, voluptas, libero laborum corrupti cupiditate minus nemo a
        nisi expedita beatae accusantium.
      </p>
